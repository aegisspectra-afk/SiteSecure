...
def test_openapi_and_health():
    ...
    for path in (
        ...
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/document",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/versions",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/versions/compare",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/events",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/sections",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/apply-package",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/save-as-template",
        "/api/v1/workspaces/{workspace_id}/quotes/{quote_id}/margin-override",
        ...
        "/api/v1/workspaces/{workspace_id}/projects/from-quote",
