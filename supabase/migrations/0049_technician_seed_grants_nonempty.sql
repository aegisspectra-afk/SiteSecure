-- Housekeeping: renumbered from 0048_* to avoid collision with
-- 0048_v3_plan_labels_free_pro_enterprise.sql (authoritative P1-T01).
-- Already applied on production under migration name
-- "0048_technician_seed_grants_nonempty" — do NOT re-apply this file as a new migration.
--
